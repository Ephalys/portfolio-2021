...
export const themes = {
    'light': {
        ...
        themeSwitcherBackground: colors.black,
        themeSwitcherText: colors.white,
        title: colors.black,
    ...
    'dark': {
        ...
        secondaryBackground: colors.extremelightgrey,
        themeSwitcherBackground: colors.white,
        themeSwitcherText: colors.black,
        title: colors.white,
    ...
    'rainbow': {
        ...
        themeSwitcherBackground: colors.white,
        themeSwitcherText: colors.lightgrey,
        title: colors.white,
        secondaryTitle: colors.black,
